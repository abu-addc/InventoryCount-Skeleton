...
from src.controllers.v1.inventory_count_controller import update_inventories, add_inventory, update_quantity_counted, fetch_inventory
...
# ### auth decorator method
# Same function name will get the error `View function mapping is overwriting an existing endpoint function: inventory_count_v1.get_inventory`
